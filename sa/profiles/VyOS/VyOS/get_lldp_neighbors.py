...
class Script(BaseScript):
    name = "VyOS.VyOS.get_lldp_neighbors"
    ...
    def execute_cli(self):
        ...
        for match in self.rx_entry.finditer(v):
            ...
            if not match1:
                ...
                if not match1:
                    continue
            local_interface = match1.group("local_interface")
            n = {
            ...
            if not found:
                neighbors.append(
                    {"local_interface": match1.group("local_interface"), "neighbors": [n]}
                )
