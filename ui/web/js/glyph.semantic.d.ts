...
declare namespace NOC {
  namespace glyph {
    /**
     * Semantic icon mapping for application-wide icon usage
     * This provides a stable semantic interface regardless of the underlying icon font
     */
    const semantic: {
      // =================================================================
  ...
  /**
   * Resolves semantic icon names to actual glyph codes
   * @param semanticName - Semantic constant name (e.g., "ACTION_SAVE")
   * @param options - Optional configuration
   * @returns Font Awesome glyph code
   */
  function getGlyph(semanticName: string, options?: {
    glyphName?: string;
    fallback?: number;
    font?: string;
  }): number;
  ...
  /**
   * Get glyph by semantic category and action
   * @param category - Category name (e.g., "ACTION")
   * @param action - Action name (e.g., "SAVE")
   * @param options - Optional configuration
   * @returns Font Awesome glyph code
   */
  function getGlyphBy(category: string, action: string, options?: {
    glyphName?: string;
    fallback?: number;
    font?: string;
  }): number;
