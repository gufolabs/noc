...
> [!WARNING]
>
> Для работы адаптера потребуется установить библиотеку [python-zabbix-utils](https://github.com/zabbix/python-zabbix-utils), это можно сделать командой `./bin/pip install -r .[zabbix]` из директории `noc`
