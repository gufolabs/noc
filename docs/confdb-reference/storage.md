...
* *Plug-and-play* - Available out-of-the-box. Do not require additional configuration or maintenance.
...
* *Mirroring* - configurations can be uploaded to `External Storage`.
